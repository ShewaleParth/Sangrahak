...
// Admin Schema (add after Alert Schema, around line 75)
...
// Authentication Middleware (add after models, around line 85)
...
// ==================== AUTH ROUTES ====================
// Add these routes before your existing routes (around line 100)
  ...
  try {
    ...
    if (!admin.isActive) {
      return res.status(403).json({
        success: false,
        message: 'Account is disabled. Contact system owner.'
      });
    }
